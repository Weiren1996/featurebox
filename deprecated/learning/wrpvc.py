...
# """for element site"""
data = pd.read_excel(r'/data/home/wangchangxin/data/wr/wrpvc.xlsx',
...
#
corr_plot(corr, x_name=x_p_name, left_down=None, right_top=None, threshold_left=0, threshold_right=0.9,
